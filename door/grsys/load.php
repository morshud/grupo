    ...
    if ($arg[0]['type'] === 'appearance' && gr_role('access', 'sys', '2')) {
        ...
        if (gr_role('access', 'sys', '1')) {
            ...
            if (strtolower(trim($arg[0]['rebuilder'])) == 'yes') {
                gr_prnt('window.location.href = "act/reset/";');
            } else {
                gr_prnt('window.location.href = "";');
            }
        }
...
function gr_globalreset($act) {
    if (gr_role('access', 'sys', '1')) {
        ...
        if (empty($act[1])) {
            gr_prnt("<meta http-equiv='refresh' content='3;url=".url()."act/reset/step2/'>");
            ...
            gr_prnt("<meta http-equiv='refresh' content='5;url=".url()."act/reset/step3/'>");
            gr_prnt('<body><div>Rebuilding Cache (User Roles). Please Wait...</div></body>');
        } else if ($act[1] == 'step3') {
            gr_cache('roles');
            gr_prnt("<meta http-equiv='refresh' content='5;url=".url()."act/reset/step4/'>");
            gr_prnt('<body><div>Rebuilding Cache (Blacklist & Filter Words). Please Wait...</div></body>');
        } else if ($act[1] == 'step4') {
            gr_cache('blacklist');
            gr_cache('filterwords');
            gr_prnt("<meta http-equiv='refresh' content='5;url=".url()."act/reset/step5/'>");
            gr_prnt('<body><div>Rebuilding Cache (Settings). Please Wait...</div></body>');
        } else if ($act[1] == 'step5') {
            gr_cache('settings');
            gr_prnt("<meta http-equiv='refresh' content='5;url=".url()."act/reset/step6/'>");
            ...
            fwrite($ccfile, $ccontent);
            fclose($ccfile);
            gr_prnt("<meta http-equiv='refresh' content='5;url=".url()."act/reset/finished/'>");
            ...
            setcookie('grcreset', 1, 0, "/");
            gr_prnt("<meta http-equiv='refresh' content='2;url=".url()."'>");
